...
function updateProgressBars() {
    ...
    currentStoryData.forEach((story, index) => {
        ...
        if (index < currentStoryIndex || story.viewed) {
            bar.classList.add('completed'); // Completed or viewed stories
    ...
    if (activeBar && !currentStoryData[currentStoryIndex].viewed) {
